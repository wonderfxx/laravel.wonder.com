...
@section('content')
    <div class="wrapper wrapper-content animated fadeIn">
        <div class="col-xs-12 m-t">
            ...
            <div class="form-group">
                <div class="col-xs-6">
                    {!! Form::input('text','game_coins_name','',[
                ...
                <div class="col-xs-6">
                    {!! Form::select('game_type',$game_types,'web',[
            ...
            <div class="form-group">
                ...
                <div class="col-xs-6">
                    {!! Form::input('text','proportion_usd','',[
            ...
            <div class="form-group">
                <div class="col-xs-6">
                    {!! Form::input('text','proportion_local','',[
                ...
                <div class="col-xs-6">
                    {!! Form::input('text','proportion_local_currency','',[
            ...
            <div class="form-group">
                ...
                <div class="col-xs-6">
                    {!! Form::input('text','proportion_cp_currency','',[
            ...
            <div class="form-group">
                <div class="col-xs-6">
                    {!! Form::select('game_status',$game_status,'T',[
                        'class' => 'form-control chosen-select'
                    ]) !!}
                </div>
            </div>
