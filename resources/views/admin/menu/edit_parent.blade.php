...
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group">
            <label class="control-label col-sm-3">{!! $headerInfo['menu_icon']['title'] !!}：</label>
            <div class="col-sm-8">
                <input type="text"  class="form-control" required="" value="{!! $data->menu_icon !!}"
